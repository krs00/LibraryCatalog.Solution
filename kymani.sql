...
--
-- Host: localhost    Database: kymani
-- ------------------------------------------------------
...
CREATE TABLE `Authors` (
  ...
  KEY `IX_Authors_BookId` (`BookId`),
  CONSTRAINT `FK_Authors_Books_BookId` FOREIGN KEY (`BookId`) REFERENCES `Books` (`BookId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-25 14:31:00
